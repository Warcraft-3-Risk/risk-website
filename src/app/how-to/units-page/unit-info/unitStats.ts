...
> = {
  ...
  general: {
    ...
    attack: { value: 62, icon: '/images/icons/attack-normal-icon.webp' },
    armor: { value: 0, icon: '/images/icons/armor-heavy-icon.webp' },
  },
  artillery: {
  ...
  tank: {
    ...
    attack: { value: 64, icon: '/images/icons/mortar-damage-type.webp' },
  ...
  admiral: {
    health: { value: 900, icon: '/images/icons/health-icon.webp' },
    attack: { value: 48, icon: '/images/icons/attack-normal-icon.webp' },
    armor: { value: 0, icon: '/images/icons/medic-armor-type.webp' },
  },
  'transport-ship': {
    health: { value: 300, icon: '/images/icons/health-icon.webp' },
    attack: { value: 0, icon: '/images/icons/medic-damage-type.webp' },
    armor: { value: 0, icon: '/images/icons/armor-heavy-icon.webp' },
  },
  ...
  'warship-a': {
    ...
    attack: { value: 38, icon: '/images/icons/attack-normal-icon.webp' },
    armor: { value: 0, icon: '/images/icons/armor-heavy-icon.webp' },
  },
  'warship-b': {
    health: { value: 2000, icon: '/images/icons/health-icon.webp' },
    attack: { value: 98, icon: '/images/icons/attack-normal-icon.webp' },
    armor: { value: 0, icon: '/images/icons/armor-heavy-icon.webp' },
  },
  'battleship-ss': {
